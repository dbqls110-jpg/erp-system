        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <select id="customer-create-category" value={form.category} onChange={(event) => set("category")(event.target.value)} className="h-9 w-full rounded-[10px] border border-transparent bg-background px-3 text-sm outline-none focus-visible:ring-3 focus-visible:ring-ring/30">
            ...
            <div className="space-y-1.5">
              ...
              <select id="customer-create-status" value={form.status} onChange={(event) => set("status")(event.target.value)} className="h-9 w-full rounded-[10px] border border-transparent bg-background px-3 text-sm outline-none focus-visible:ring-3 focus-visible:ring-ring/30">
