    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="shadow-xs">
          <CardHeader className="pb-1"><p className="text-xs font-medium text-muted-foreground">출근일수</p></CardHeader>
          <CardContent><p className="text-2xl font-bold text-foreground">{workDays}일</p></CardContent>
        </Card>
        <Card className="shadow-xs">
          <CardHeader className="pb-1"><p className="text-xs font-medium text-muted-foreground">총 근무시간</p></CardHeader>
          <CardContent><p className="text-2xl font-bold text-primary">{totalHours.toFixed(1)}h</p></CardContent>
        </Card>
        <Card className="shadow-xs">
          <CardHeader className="pb-1"><p className="text-xs font-medium text-muted-foreground">일 평균</p></CardHeader>
          <CardContent><p className="text-2xl font-bold text-primary">{workDays > 0 ? (totalHours / workDays).toFixed(1) : "0"}h</p></CardContent>
        </Card>
      </div>
