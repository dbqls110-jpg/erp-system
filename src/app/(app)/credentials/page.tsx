...
export default async function CredentialsPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <PageIntro>등록된 인증 정보를 관리합니다.</PageIntro>
      </div>

      <Card>
        <CardContent>
          <div className="flex items-start gap-2 rounded-[10px] border border-amber-500/40 bg-amber-500/10 p-3 text-[13px] text-amber-700 dark:text-amber-400" role="note">
