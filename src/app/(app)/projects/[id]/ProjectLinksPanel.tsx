...
export function ProjectLinksPanel({
  ...
  const [adding, setAdding] = useState<"customer" | "partner" | null>(null);
  ...
  return (
    <div className="space-y-4">
      <Section title="거래처" items={customers} options={customerOptions} kind="customer" tone="blue" />
      <Section title="파트너" items={partners} options={partnerOptions} kind="partner" tone="violet" />
    </div>
  );
}
