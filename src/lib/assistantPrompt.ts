...
const UPDATE_FORMAT = [
  ...
  "",
  "```erp-update",
  '{"target":"space_registration_create","label":"공간 등록 접수","fields":{"spaceName":"공간1","address":"서울시 ...","spaceType":"스튜디오","capacity":100,"weekdayRate":88,"weekendHolidayRate":110,"minimumRentalDays":3,"vatIncluded":"별도"},"reason":"공간 등록 접수"}',
  "```",
  "",
